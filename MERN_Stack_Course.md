...
The first one is searching by name and impop input box which is going to say search by name and the value is gonna be the search name and on change is gonna be on change search name to so as soon as someone types something it gets set as the name
