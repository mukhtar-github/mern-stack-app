...
So if someone searches for *a name, a zipcode, or a cuisine,* these three functions are going to when someone types into the search box we're going to take the value of the search box and we're going to set the name or set the zip or set the cuisine to whatever thing that the person typed in or in the case of the cuisine if they selected it.
