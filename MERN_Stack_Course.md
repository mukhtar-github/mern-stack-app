...
Okay the final method is the delete review this is going to be a little different this is going to actually have a query parameter instead of the in the body the the id to be deleted is going to be a query parameter right in the url and then we're going to get the user id right in the body
