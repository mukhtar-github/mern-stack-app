...
And then we're going to be making a *get request*, so go to *localhost:4000/api/v1/restaurants* and now we can see all the restaurants on the side here so you can see each one that has the address it has the burrow the cuisine
